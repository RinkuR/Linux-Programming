...
union semun { //used with semctl() system call for initializing 
  ...
  int val;                 //for SETVAL  command 
  unsigned short *array;   //for SETALL command 
...
int main()
{
  ...
  //the usage of the semaphores are decided by developers and one
  //such case is as below :
  ...
  //shma->buf_size_max = 100;   //this is incorrect ???
 ...
 //object !!! 
  ...
  u1.array = ary1;
  //after this system call API is successful, elements of the
  //ary1 will contain values retrieved from semaphores of the
  //semaphore object !!!
