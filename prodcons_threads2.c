...
void *display_status_thread(void *arg)
{
   ...
   while(1){
        ...
        //sleep will block this process for 3 secs - during 
        //3 secs, this process is maintained in a system 
        //wq !! man sleep !!!
        sleep(3);
   }
...
int main()
{
  ...
  //ptr = malloc(32*1024);
     ...
     //mmap allocates anonymous memory regions, not heap and
     //not global data !!! in fact, malloc()/library uses
     //such kind of allocations and manages the allocated
     //memory, internally !!!      
     //mmap() may be used in this form or subtly in a
     //different form in real time !!! 
     //
     //MAP_PRIVATE makes sure that the VAD is private 
     //to this process
     //MAP_ANONYMOUS makes sure that this mapping 
     //is not associated with a regular file !!!
