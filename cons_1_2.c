...
int main()
{
  ...
  printf("the actual values of the semaphores are %d, %d, %d\n", \
   ...
   //in this context, semphore with index 2 is used to 
   //count filled slots and also synchronize this process,
   //when filled slots are not available with respect to 
   //the other process - this synchronization is achieved
